...
--filter-udp=80,443,3478-3482,3484,3488,3489,3491-3493,3495-3497,42377-62133 --ipset="%LISTS%ipset-all.txt" --hostlist-exclude="%LISTS%list-exclude.txt" --ipset-exclude="%LISTS%ipset-exclude.txt" --dpi-desync=fake --dpi-desync-repeats=11 --dpi-desync-fake-quic="%BIN%quic_initial_www_google_com.bin" --new ^
--filter-tcp=80,443,3478-3482,3484,3488,3489,3491-3493,3495-3497,42377-62133,%GameFilter% --ipset="%LISTS%ipset-all.txt" --hostlist-exclude="%LISTS%list-exclude.txt" --ipset-exclude="%LISTS%ipset-exclude.txt" --dpi-desync=fake,multisplit --dpi-desync-split-seqovl=654 --dpi-desync-split-pos=1 --dpi-desync-fooling=ts --dpi-desync-repeats=8 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_max_ru.bin" --dpi-desync-fake-tls="%BIN%tls_clienthello_max_ru.bin" --new ^
--filter-udp=3478-3482,3484,3488,3489,3491-3493,3495-3497,42377-62133 --filter-l7=stun --dpi-desync=fake --dpi-desync-fake-stun="%BIN%quic_initial_www_google_com.bin" --dpi-desync-repeats=6 --new ^
--filter-tcp=3478-3482,3484,3488,3489,3491-3493,3495-3497,42377-62133 --filter-l7=stun --dpi-desync=fake --dpi-desync-fake-tls="%BIN%tls_clienthello_max_ru.bin" --dpi-desync-repeats=6 --new ^
